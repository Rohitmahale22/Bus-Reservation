...
%>
<h1 style="background-color:aqua;"  align="center"><u> *HERE YOU CAN SEE YOUR BOOKING DETAILS* </u> </h1>
...
<td> <a href="infoedit.jsp?id=<%= rs.getString(1) %>"target="blank"><button>BOOK</button></a></td>
